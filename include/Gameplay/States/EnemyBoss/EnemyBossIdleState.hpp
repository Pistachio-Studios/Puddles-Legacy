...
public:
    ...
    inline void Update(float dt) override
    {
        ...
        //Animation
        app->render->DrawTexture(enemyboss->bossIdle.texture, enemyboss->position.x - 60, enemyboss->position.y - 150, &enemyboss->bossIdle.GetCurrentFrame(), 1.0f, enemyboss->pbody->body->GetAngle() * RADTODEG, 1.0f, enemyboss->flip);
