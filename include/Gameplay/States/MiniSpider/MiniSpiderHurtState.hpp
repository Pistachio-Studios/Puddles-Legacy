...
public:
    ...
    inline void Update(float dt) override
    {
        ...
        //Animation
        app->render->DrawTexture(minispider->spiderDamage.texture, minispider->position.x - 100, minispider->position.y - 150, &minispider->spiderDamage.GetCurrentFrame(), 1.0f, minispider->pbody->body->GetAngle() * RADTODEG, 0.5f, minispider->flip);
